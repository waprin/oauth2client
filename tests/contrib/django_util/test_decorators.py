...
class OAuth2EnabledDecoratorTest(TestWithDjangoEnvironment):
    ...
    def setUp(self):
        ...
        if hasattr(django.conf.settings, 'GOOGLE_OAUTH2_STORAGE_MODEL'):
            del django.conf.settings.GOOGLE_OAUTH2_STORAGE_MODEL
    ...
    def test_no_credentials_without_credentials(self):
        ...
        self.assertIs(response.status_code, http_client.OK)
...
class OAuth2RequiredDecoratorTest(TestWithDjangoEnvironment):
    ...
    def setUp(self):
        ...
        if getattr(
                ...
                'GOOGLE_OAUTH2_STORAGE_MODEL',None) is not None:
            del django.conf.settings.GOOGLE_OAUTH2_STORAGE_MODEL
